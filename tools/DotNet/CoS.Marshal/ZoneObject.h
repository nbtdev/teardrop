...
#if !defined(ZONEOBJECT_MARSHAL_INCLUDED)
#define ZONEOBJECT_MARSHAL_INCLUDED
...
namespace CoS
{
	...
	namespace Game
	{
		public ref class ZoneObject
		{
		public:

			static Gfx::MeshInstance^ GetRenderable(CoS::Object^);
		};
	}
}

#endif // ZONEOBJECT_MARSHAL_INCLUDED
