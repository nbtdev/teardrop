...
#if !defined(OBJECTLIBRARY_MARSHAL_INCLUDED)
#define OBJECTLIBRARY_MARSHAL_INCLUDED
...
namespace CoS
{
	...
	namespace Game
	{
		public ref class ObjectLibrary
		{
		public:
			ObjectLibrary();
			~ObjectLibrary();
...
#endif // OBJECTLIBRARY_MARSHAL_INCLUDED
