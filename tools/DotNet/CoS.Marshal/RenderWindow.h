...
#if !defined(RENDERWINDOW_MARSHAL_INCLUDED)
#define RENDERWINDOW_MARSHAL_INCLUDED
...
namespace CoS
{
	...
	namespace Gfx
	{
		...
		public ref class RenderWindow : RenderTarget
		{
			CoS::GfxRenderWindow* m_pWindow;
			System::Windows::Forms::Control^ m_parent;

		public:
			RenderWindow(CoS::GfxRenderWindow*);
			~RenderWindow();
			!RenderWindow();

			void Resize(int width, int height);
			Viewport^ AddViewport(float x, float y, float w, float h);

			property System::Windows::Forms::Control^ Parent
			{
...
#endif // RENDERWINDOW_MARSHAL_INCLUDED
